...
SOURCE_DIR="Subject3Bottle/ResultClipSizeUp200"
DATASET_DIR="dataset_subject3bottle_size200"

echo "Preparing Subject 3 Bottle, ResultClipSizeUp200 split..."
mkdir -p \
...
echo
echo "Finished. Model saved to subject3bottle_size200_cnn_pi.pth"
