...
SOURCE_DIR="Subject2GloveOff/ResultClipSizeUp200"
DATASET_DIR="dataset_subject2_gloveoff_size200"

echo "Preparing Subject 2 Glove Off, ResultClipSizeUp200 split..."
mkdir -p \
...
.venv/bin/python main_cnn_emg.py \
    ...
    --batch-size 32 \
    --epochs 200 \
    --model-path subject2_gloveoff_size200_cnn_pi.pth

echo
echo "Finished. Model saved to subject2_gloveoff_size200_cnn_pi.pth"
