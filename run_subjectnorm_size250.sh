...
SOURCE_DIR="SubjectNorm/ResultClipSizeUp250"
DATASET_DIR="dataset_subjectnorm_size250"

echo "Preparing Subject Norm, ResultClipSizeUp250 split..."
mkdir -p \
...
echo
echo "Finished. Model saved to subjectnorm_size250_cnn_pi.pth"
