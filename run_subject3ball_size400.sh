...
SOURCE_DIR="Subject3Ball/ResultClipSizeUp400"
DATASET_DIR="dataset_subject3ball_size400"

echo "Preparing Subject 3 Ball, ResultClipSizeUp400 split..."
mkdir -p \
...
.venv/bin/python main_cnn_emg.py \
    ...
    --batch-size 32 \
    --epochs 200 \
    --model-path subject3ball_size400_cnn_pi.pth

echo
echo "Finished. Model saved to subject3ball_size400_cnn_pi.pth"
