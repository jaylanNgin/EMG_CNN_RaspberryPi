...
SOURCE_DIR="Subject3Spoon/ResultClipSizeUp400"
DATASET_DIR="dataset_subject3spoon_size400"

echo "Preparing Subject 3 Spoon, ResultClipSizeUp400 split..."
mkdir -p \
...
.venv/bin/python main_cnn_emg.py \
    ...
    --batch-size 32 \
    --epochs 200 \
    --model-path subject3spoon_size400_cnn_pi.pth

echo
echo "Finished. Model saved to subject3spoon_size400_cnn_pi.pth"
