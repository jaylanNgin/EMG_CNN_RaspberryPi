...
SOURCE_DIR="SubjectSlow/ResultClipSizeUp200"
DATASET_DIR="dataset_subjectslow_size200"

echo "Preparing Subject Slow, ResultClipSizeUp200 split..."
mkdir -p \
...
.venv/bin/python main_cnn_emg.py \
    ...
    --batch-size 32 \
    --epochs 200 \
    --model-path subjectslow_size200_cnn_pi.pth

echo
echo "Finished. Model saved to subjectslow_size200_cnn_pi.pth"
