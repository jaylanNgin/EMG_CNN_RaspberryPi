...
SOURCE_DIR="SubjectFast/ResultClipSizeUp300"
DATASET_DIR="dataset_subjectfast_size300"

echo "Preparing Subject Fast, ResultClipSizeUp300 split..."
mkdir -p \
...
.venv/bin/python main_cnn_emg.py \
    ...
    --batch-size 32 \
    --epochs 200 \
    --model-path subjectfast_size300_cnn_pi.pth

echo
echo "Finished. Model saved to subjectfast_size300_cnn_pi.pth"
